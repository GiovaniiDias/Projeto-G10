...
# 2 clicando na aba DESAFIOS
aba_desafio=driver.find_element(By. LINK_TEXT, 'Desafios')
aba_desafio.click()
...
# 3 clicando e digitando no campo nome 
usuario = driver.find_element(By.ID, 'dadosusuario')
usuario.send_keys('Giovani dias')
sleep(2)



# 4 clicando em CLIQUE AQUI 

enviar=driver.find_element(By.ID, "desafio2")
enviar.click()
sleep(3)
# 5 escondido

escondido=driver.find_element(By. ID,'escondido')
escondido.send_keys('Giovani dias')
