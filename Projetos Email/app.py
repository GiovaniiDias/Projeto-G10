                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td> <a href="http://htmlemail.io"
                                                                                target="_blank">Editar o link desejado</a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                            ...
                                            <p>Texto extra caso aind precise explicar algum passo adicional</p>
                                            <p>Att, equipe XYZ.</p>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block">
                                    <span class="apple-link">Tudo isso é editavel, conforme desejar. Normalmente se usa referencia da empresa</span>
